...
// of channels, which is why "upcoming" looked artificially thin. Raise it so
// the whole feed (days of schedule x every channel it carries) gets parsed.
const XMLTV_ITEM_LIMIT = Number(process.env.XMLTV_ITEM_LIMIT || 50000);

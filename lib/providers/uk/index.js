...
import { getBollywoodShows, getBollywoodMovies } from "@/lib/providers/uk/bollywood-content";
...
export async function getUkGuideData(options = {}) {
  ...
  // Add sample Bollywood content (demonstrating Zee5, Netflix, Prime, Hotstar)
  // In production, this would come from actual streaming service APIs
  schedule = schedule.concat(getBollywoodShows());
  schedule = schedule.concat(getBollywoodMovies());

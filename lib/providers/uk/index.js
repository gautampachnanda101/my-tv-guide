...
export async function getUkGuideData(options = {}) {
  ...
  return {
    ...
    tvChannels: dataset.tvChannels.filter((channel) => matchQuery(channel, query)),
    canonicalChannels: dataset.canonicalChannels.filter((channel) => matchQuery(channel, query)),
    sourceAwareChannels: dataset.sourceAwareChannels.filter((channel) => matchQuery(channel, query)),
